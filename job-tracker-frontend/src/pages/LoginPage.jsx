...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-950 to-purple-950 flex flex-col lg:flex-row overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button type="submit" disabled={loading}
                className="w-full py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-2xl
                           ...
                           hover:shadow-xl hover:shadow-indigo-500/40 hover:-translate-y-0.5 transform active:translate-y-0">
                {loading ? (
